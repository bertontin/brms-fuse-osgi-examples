...
image:documentation/images/fuse-brms-video.png[Video,link="http://vimeo.com/106557607"]
...
1. Clone project or https://github.com/jbossdemocentral/brms-fuse-osgi-examples/archive/master.zip[download and unzip.]
...
- Change to the JBoss Fuse bin directory
  ...
  cd ~/temp/jboss-fuse-6.1.1.redhat-412/bin
...
- v1.0 - JBoss BRMS 6.2.0, JBoss Fuse 6.1.1 running demo projects.
